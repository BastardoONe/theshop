...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <form:input path="artistName" id="name" class="form-Control" value="${product.artistName}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <form:textarea path="artistGenrer" id="description" class="form-Control" value="${product.artistGenrer}"/>
        </div>
